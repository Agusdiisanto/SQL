...
SELECT DISTINCT componentes.ciudad,cantidad,idart
FROM envios
JOIN componentes
ON componentes.idcomp = envios.idcomp
...
FROM envios,(
 ...
 WHERE envios.cantidad > envio_promedio.promedio

 -- (o) Seleccionar los identificadores de artículos para los cuales todos sus componentes se
-- fabrican en una misma Ciudad.

SELECT articulos.idart
FROM articulos
JOIN envios 
ON envios.idart = articulos.idart
JOIN componentes 
ON componentes.idcomp = envios.idcomp
WHERE componentes.ciudad = articulos.ciudad
