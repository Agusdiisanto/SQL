CREATE TABLE usuario (
       ...
       CHECK (fecha_nacimiento <='2015/12/12'), 
       ciudad varchar(40),  
       nyap varchar(30),  
...
CREATE TABLE repositorio (      
  ...
  cantidad_pull_request INT DEFAULT(0),
  CONSTRAINT repositorio_pk PRIMARY KEY (nombre, usuario),
  CONSTRAINT fk_usuario FOREIGN KEY (usuario) REFERENCES usuario(usuario),
  CONSTRAINT chk_repositorio CHECK (tipo_repositorio = 'informativo' OR  tipo_repositorio = 'empresarial' OR tipo_repositorio = 'educacional' OR tipo_repositorio = 'comercial')
);
...
CREATE TABLE commit (   
     ...
     fecha_cambio timestamp default current_timestamp(1)
);
...
CREATE TABLE contribucion (       
  ...
  CONSTRAINT contribucion_pk PRIMARY KEY (hash, usuario),
  CONSTRAINT fk_usuario FOREIGN KEY (usuario) REFERENCES    usuario(usuario),
  CONSTRAINT fk_hash FOREIGN KEY (hash) REFERENCES commit(hash)
);
...
('znw1e9u5oxn7upv0f8vw8yjlkhxq6pgv2i27hmib' , 'd4n11.nube' , 23),
('vvu766olrew2l6ehf4777dlq51thp6bqrvn4rhvp' , 'wartortle.22' , 42),
('vsyd266u0sgh50gxv3h68pqtlqp0gudht1lldhl4' , 'Prixie' , 34),
('caxrh9cn47xqeqbxavn9rnibx3ijqj38z65m6nz0' , 'blake-kid' , 103),
('0o47bx5mkonmjm4pgliemqu0ztt18y9ycjbum66w' , 'jorgelin-88' , 12),
('e4mvde2u5g890fijz3npj1r1ke2ip79911u4l24w' , 'Taylor13' , 32),
('v5k8p2l1vfnxz7ji7ggt7ncy98innu8oqyml6ecs' , 'j.l3tto' , 39),
('zvomvdaqoui83xd15493f7xhnu7sqiivjcn5fnlt' , 'wanakin' , 12),
('12zxyw569nqduw2i8fuaf3zwc5ppf6fne4a265el' , 'dark..empire' , 43),
('51rdfkx6xk8lcjgpyykorckdk0bizuku1iy6s1jg' , 'Nitama' , 36),
('tma32e9hcrwxdeq3152ozbbayrxaqfb9rrizchmu' , 'graffiti5sandra.' , 23),
('us30aqe5kxcaaidw6ism9bp3byx57v77dgytxipn' , 'Nntendo' , 26),
('xwmimhrxqe9byimaih8fd8u77r9ouosyb463rnq7' , 'Tama' , 30),
('8pf8chb09d797ngv0vb6rcx7t9m6q2ck9w5cg072' , 'Prixie' , 24),
('7lvq1swu3tfkj2b9tjdcoehhsgoalrz8u47n3uou' , 'jorgelin-88' , 19),
('otikn1mr8ruy04cfy6lbi1ygby39rhl9cdfj45sf' , 'theViper' , 9),
('z0yhgmot1ths0ylc9xtqyn2r9jfvmzua3955pg9l' , 'blake-kid' , 48),
('gblifd45z1fsd4p844v2oy1oved7mbe4ypjh5w89' , 'zeroCool' , 8),
('axix4dhqa4a3a56vpwjet2th34c9fyozcxebfokc' , 'd.phntm_phreak' , 5),
('szb6pnrmolx5yh6osobhor88x7iptg1dqs46lgw5' , 'd4n11.nube' , 42),
('2tgjumfu5qu3whmq9kv15hm81sdx92ky9iavonsn' , 'ZainParsec' , 46),
('d7tbfnxcnifb47gfejr2jp9e9zmxysbp4og2lgfc' , 'DilanLens.78' , 49),
('45at10lxm8q0dv7fyfz9up9f0xyl5ufrf1cm3kkc' , 'MonkeyJunkie' , 12),
('ry1pja1jdrb52nntgjk2z679uhz8msxjipf6okeb' , 'wartortle.22' , 38),
('fvuakz6mauq7emxo38p5akc5cekfasu5kdx3weks' , 'wanakin' , 32),
('40rnde11x18tfb14y22el0pv3zv3llrhmtoqz9ca' , 'Jonesy' , 28),
('h5ui8d3xh5n053m2dhk9wdxvao901z62a54ca5r7' , 'd4n11.nube' , 39),
('gfsynzul47utqhm7attchv1w3bozssmwuqf0876v' , 'red' , 45),
('teaytstlpe1s2rh01bcvy3hwp1kik93zs4k740lj' , 'salem.96' , 12),
('b6oxd2s2c9jwo3f7dlkja7c0zgm2st0nj9kbej5k' , 'aka-nice' , 14),
('hnkjen45cjhahtfrgnfpjv0o870oumhk6ch3lrzi' , 'Cuccittini' , 46),
('5j2uj5n2ebzqww0uv6g1t9hgbhqbmf2lgzo869p2' , 'NicoV' , 16),
('cpxwagwok5p5eg2zayaem9jg3ap323hb8pl1jbev' , 'EACCES' , 18),
('q6sk3nk4t6ewm7waymapfeqiflzg6qvhtohog2je' , 'NicoV' , 27),
('crewfqmayvo6q5nzs63bgwewr4ikf851zrc1tc4v' , 'miss.pink' , 31),
('q136ci50b91m6k004srqib061pdbrhbnlp6kwyha' , 'ruki_5353' , 30),
('jy96fo621wcalq9gitvdgp6yox4vppnok7ceu4og' , 'Jonesy' , 83),
('v2hn0ze1lg126xhg682n1pmdtxgcktxp6izgnk3z' , 'Titta' , 49),
('qtcw57fr9uugropg0nwm5upkflfqql39dp4gass8' , 'theViper' , 39),
('l98mw0539ni5f5f2ibqgqw1q63nycrdh0b5jfbhd' , 'Carlin__C' , 12),
('7i2hn7609lg3rizjws2dpai7w6qdslnhn4tnyrz7' , 'M1lanes4' , 43),
('m5efo6i5io66zyysr5ci9hic2gey976mus21gooa' , 'dark..empire' , 12),
('41gka8ypl3ce776th849ph7jls7f68lbqk077lj9' , 'LRD.nikon' , 11),
('5hz8ojppu3tzbgjw3kzf7j88xytxz795yndw5x03' , 'Liereyy' , 1),
('oyfel7o1np1471i4926422p170yycuttddkwvvlq' , 'red' , 3),
('e8v54vti5jefhxvm3dco2h28himb1jv07hhk4yig' , 'anaM0nk' , 23),
('69qh1euh55ybbx9881nshc8lx2pa1wy3zyb5fdob' , 'juan' , 2),
